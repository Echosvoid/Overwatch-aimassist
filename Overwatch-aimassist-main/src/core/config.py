...
class Config:
    ...
    # Smoothing settings
    BASE_SMOOTHING: float = 0.25         # Increased for more stability
    SIZE_SMOOTHING_FACTOR: float = 0.35  # Reduced size influence
    DISTANCE_SMOOTHING_FACTOR: float = 0.2  # Reduced distance influence
    VELOCITY_SMOOTHING_FACTOR: float = 0.25  # Balanced velocity influence
    ...
    PREDICTION_TIME: float = 0.08        # Reduced for more immediate response
    MAX_PREDICTION_DISTANCE: int = 120   # Balanced prediction distance
